...
VALUES ('Goal Scored', 'goal', 'moment', 'Predict a player to score a goal'),
       ...
       ('Over 2.5 Goals', 'over_goals', 'match', 'More than 2.5 goals in the match') ON CONFLICT (name) DO NOTHING;
