...
VALUES ('00000000-0000-0000-0000-000000000001',
       ...
       ('00000000-0000-0000-0000-000000000003',
        ...
        '{}'::jsonb,
        'authenticated',
        'authenticated') ON CONFLICT (id) DO NOTHING;

-- ============================================================
-- public.users
-- ============================================================
INSERT INTO public.users (id, auth_id, display_name, has_seen_onboarding, created_at, updated_at)
VALUES (gen_random_uuid(), '00000000-0000-0000-0000-000000000001', 'Dev User 1', true, NOW(), NOW()),
       (gen_random_uuid(), '00000000-0000-0000-0000-000000000002', 'Dev User 2', false, NOW(), NOW()),
       (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Dev User 3', false, NOW(),
        NOW()) ON CONFLICT (auth_id) DO NOTHING;
