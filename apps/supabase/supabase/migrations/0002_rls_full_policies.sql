...
DROP POLICY IF EXISTS select_scoring_results ON scoring_results;
...
DROP POLICY IF EXISTS select_own_user_gameweek_states ON user_gameweek_states;
...
DROP POLICY IF EXISTS insert_own_user_gameweek_states ON user_gameweek_states;
...
DROP POLICY IF EXISTS update_own_user_gameweek_states ON user_gameweek_states;
